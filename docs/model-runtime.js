...
export class BrowserModelRuntime{
 constructor(evidence=()=>{}){this.evidence=evidence;this.text=null;this.vision=null;this.device=navigator.gpu?"webgpu":"wasm";this.ollamaBase=localStorage.getItem("LEEWAY_OLLAMA_BASE_URL")||"http://127.0.0.1:11434";this.ollamaState="UNEXPOSED";}
