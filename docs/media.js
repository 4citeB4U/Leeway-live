...
WHY = Provides permission-gated browser camera and microphone input while refusing generic browser TTS as Agent Lee identity
...
export class BrowserMediaAdapter{
 ...
 capabilities(){const SR=window.SpeechRecognition||window.webkitSpeechRecognition;return{camera:!!navigator.mediaDevices?.getUserMedia,speechRecognition:!!SR,speechSynthesis:false,cloneVoice:false}}
